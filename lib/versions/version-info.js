...
var NO_REMOTE_REQUESTS = !process.env['NG1_BUILD_REMOTE_VERSION_REQUESTS'];
...
var getCodeName = function(tagName) {
  ...
  console.log("gitCatOutput:" + gitCatOutput);
...
var getTaggedVersion = function() {
  ...
  if (gitTagResult.code === 0) {
    ...
    if (version && checkBranchPattern(version.version, currentPackage.branchPattern)) {
      version.codeName = 'promise-rectification'; //getCodeName(tag);
...
exports.gitRepoInfo = getGitRepoInfo();
exports.previousVersions = previousVersions = getPreviousVersions();
exports.cdnVersion = cdnVersion = previousVersions;
exports.currentVersion = previousVersions;
*/
